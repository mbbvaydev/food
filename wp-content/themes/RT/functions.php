...
if ( ! class_exists( 'RT_Theme_Setup' ) ) {
	...
	class RT_Theme_Setup {
		...
		public function register_assets() {
			...
			wp_enqueue_style( 'support-css', __RT_THEME_CSS . '/support.css', array(), '1.0.0' );
			...
			wp_register_script( 'rt-countto', __RT_THEME_JS . '/jquery.countto.js', array( 'jquery' ), '1.0.0', true );
			wp_register_script( 'rt-waypoints', __RT_THEME_JS . '/waypoints.min.js', array( 'jquery' ), '1.0.0', true );
